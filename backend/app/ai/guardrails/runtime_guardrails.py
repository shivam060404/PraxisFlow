...
from app.ai.guardrails.base import BaseGuardrail, GuardrailAction, GuardrailLayer, GuardrailSeverity, GuardrailResult, GuardrailContext
from app.core.config import settings
from app.core.paths import GUARDRAILS_CONFIG
...
class NeMoGuardrailsRuntime(BaseGuardrail):
    ...
    def __init__(
        ...
        self.colang_config_path = colang_config_path or str(GUARDRAILS_CONFIG)
